...
class ItemDetailScheduler(BaseScheduler):
    ...
    def __init__(self):
        ...
        self.project_name = "TB"
        self.scheduler_name = "shop_search"
        self.redis_key_todo = "(tb)list_shop_search:TODO"
...
def main():
    ...
    # 先调度淘宝的
    sql = 'select search_name, cate_name, "1" as `page` from tb_app_cate where search_name != "Null"'
